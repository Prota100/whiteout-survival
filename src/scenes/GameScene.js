// Game Scene - Main gameplay orchestrator
// NOTE: This file is still large (~7500 lines). Further refactoring into
// systems with event-based communication is recommended as a follow-up.
// Method groups:
// - create/init (line ~1-540)
// - Save/Restore (~540-600)
// - Background/Resources (~600-700)
// - Wave/Spawn (~700-900)
// - Combat (~900-1150)
// - Tutorial/FTUE (~1150-1350)
// - XP/Level (~1350-1500)
// - Buff System (~1500-1800)
// - Equipment Drops (~1800-2000)
// - Animal AI (~2000-2250)
// - NPC (~2250-2400)
// - Building/Crafting (~2400-2650)
// - Survival (~2650-2800)
// - UI (~2800-3350)
// - Upgrade UI (~3350-3650)
// - Wave/Blizzard (~3650-4250)
// - Boss (~4250-4650)
// - Minimap/Vignette (~4650-4950)
// - Rhythm/Alerts (~4950-5250)
// - Victory/GameOver (~5250-5650)
// - update() (~5650-6250)
// - Achievements (~6250-6550)
// - Hidden Boss/Secrets (~6550-7050)
// - Random Events (~7050-7350)
// - Zone Alerts (~7350-7534)
class GameScene extends Phaser.Scene {
  ...
  killAnimal(a) { 
    ...
    // Try sound but don't crash if it fails
    try { playKill(); } catch(e) {}
    
    // Only essential: XP gain (with safety checks)
    try {
      let xp = 3;
      if (a.animalType === 'rabbit') xp = 5;
      else if (a.animalType === 'deer') xp = 8;
      else if (a.animalType === 'wolf') xp = 18;
      else if (a.animalType === 'bear') xp = 35;
      
      if (this.gainXP) this.gainXP(xp);
    } catch(e) { console.error('gainXP error:', e); }
    
    // Kill count
    try {
      if (!this.stats) this.stats = {};
      if (!this.stats.kills) this.stats.kills = {};
      this.stats.kills[a.animalType] = (this.stats.kills[a.animalType] || 0) + 1;
    } catch(e) {}
